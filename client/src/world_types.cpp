 ...
 * <File description>
 *
 * $Id: world_types.cpp,v 1.2 2002/06/06 05:51:01 robofly Exp $
 */
...
{
	if (ShowDebugInChat) nlinfo("Entering CWorldType loadFromTextFile file.");
...
{
	if (ShowDebugInChat) nlinfo("Entering createFromTextFile CWorldType. %s", configFile.getFilename());
...
{
	if (ShowDebugInChat) nlinfo("Entering createFromTextFile CFirearmType. %s", configFile.getFilename());
...
{
	if (ShowDebugInChat) nlinfo("Entering createFromTextFile CBulletType. %s", configFile.getFilename());
